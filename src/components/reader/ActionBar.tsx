...
export function ActionBar({
  ...
  const btnLock = (
    <svg width="10" height="10" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24" style={{ opacity: 0.6 }}>
        ...
        >
          ...
          {!(noteOpen && editingNote) && (
            <div style={{ display: "flex", gap: 8 }}>
              {/* Highlight — locked for free */}
              <button
                onClick={isPaid ? onHighlight : undefined}
                style={{
                  display: "flex", alignItems: "center", justifyContent: "center", gap: 6,
                  padding: "10px 16px", borderRadius: 9,
                  border: isPaid && allHighlighted
                    ? "1px solid var(--yellow-hl-border)"
                    : "1px solid var(--border)",
                  background: isPaid && allHighlighted
                    ? "var(--yellow-hl)"
                    : "var(--bg2)",
              ...
              {/* Note — locked for free */}
              <button
                onClick={isPaid ? handleNoteToggle : undefined}
                style={{
                  display: "flex", alignItems: "center", justifyContent: "center", gap: 6,
                  padding: "10px 16px", borderRadius: 9,
                  border: isPaid && noteOpen
                    ? "1px solid var(--blue-border)"
                    : "1px solid var(--border)",
                  background: isPaid && noteOpen
                    ? "var(--blue-bg)"
                    : "var(--bg2)",
                  fontSize: 13.5, fontWeight: 500,
                  fontFamily: "'Inter', sans-serif",
          ...
          {/* ═══ FREE: upsell row below buttons ═══ */}
          {!isPaid && !(noteOpen && editingNote) && (
            <div style={{
              display: "flex", alignItems: "center", justifyContent: "center",
              gap: 5, marginTop: 8, paddingTop: 8,
              borderTop: "1px solid var(--border)",
            }}>
              <svg width="11" height="11" fill="none" stroke="var(--accent)" strokeWidth="2" viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
                <rect x="3" y="11" width="18" height="11" rx="2" />
                <path d="M7 11V7a5 5 0 0110 0v4" />
              </svg>
